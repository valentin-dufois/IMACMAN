...
namespace debug
{
 ...
 class DebugOutput
 {
  public:
   ...
   static void errorCallback(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar *msg, const void *data)
   {
      //display warnings/errors however you like
     std::cout << "\n----------[ DEBUG OUTPUT OPENGL ERROR ]----------"    << std::endl;
